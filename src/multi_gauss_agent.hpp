...
public:
  ...
  multi_gauss_agent(double lambda, double lambda_c, double alpha_v, double alpha_u, double alpha_r, double epsilon, double initial_value,
                     int num_features,
    ...
    : max_state(6), min_state(6), max_clip_state(6), min_clip_state(6),
      ...
      critic_forward (tc, lambda_c, alpha_v, initial_value),
      critic_backward (tc, lambda_c, alpha_v, initial_value),
      ...
      rng2(0), epsilon(epsilon), weighted_dist_choice(weighted_dist_choice), ucb_factor(ucb_factor), alpha_r(alpha_r), continuing(continuing)
  { }
