...
tile_coder sarsa_agent::make_tile_coder(double tile_weight_exponent, const std::vector<int>& subspaces) {
...
// policy_gradient_actor sarsa_agent::make_thrust_actor_forward
...
//
//
// policy_gradient_actor sarsa_agent::make_thrust_actor_backward
// (const tile_coder_base& tc, double lambda, double alpha, bool trunc_normal) {
//   const double max_thrust = cart_pole_simulator::MAX_THRUST();
//   return policy_gradient_actor (tc, lambda, alpha,
...
// policy_gradient_actor sarsa_agent::make_rcs_actor_cw
// (const tile_coder_base& tc, double lambda, double alpha, bool trunc_normal) {
...
//
//
// policy_gradient_actor sarsa_agent::make_rcs_actor_ccw
// (const tile_coder_base& tc, double lambda, double alpha, bool trunc_normal) {
//   const double max_rcs = cart_pole_simulator::MAX_RCS();
//   return policy_gradient_actor (tc, lambda, alpha,
...
VectorXi sarsa_agent::get_state_action_features(const VectorXi& features, bool action) {
  if (action) {
...
Eigen::Vector2d sarsa_agent::get_policy_probs(const VectorXi& features) {
...
cart_pole_simulator::action sarsa_agent::compute_action([[maybe_unused]] std::mt19937& rng, const VectorXi& features) {
...
cart_pole_simulator::action sarsa_agent::initialize(std::mt19937& rng, VectorXd state) {
  clip_state(state);
...
cart_pole_simulator::action sarsa_agent::update(std::mt19937& rng, VectorXd state,
