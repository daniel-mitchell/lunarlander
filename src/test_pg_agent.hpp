#ifndef _TEST_PG_AGENT_HPP
#define _TEST_PG_AGENT_HPP
...
class test_linear_function_approx {
...
public:
  ...
  test_linear_function_approx(const tile_coder_base& tc, double falloff, double initial_value=0, double threshold=0.05)
...
public:
  ...
  test_td_critic(const tile_coder_base& tc, double lambda, double alpha, double initial_value=0, double gamma=1)
...
class test_pg_actor {
  ...
  test_linear_function_approx alpha, beta;
  VectorXi features;
  double action;
...
public:
  ...
  test_pg_actor(const tile_coder_base& tc, double lambda, double alphaStep,
