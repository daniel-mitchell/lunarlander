...
mountain_car_simulator::action gauss_agent::initialize(std::mt19937& rng, VectorXd state) {
  clip_state(state);
...
mountain_car_simulator::action gauss_agent::update(std::mt19937& rng, VectorXd state,
