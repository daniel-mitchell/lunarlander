...
test_pg_actor beta_agent::make_thrust_actor
...
lunar_lander_simulator::action beta_agent::initialize(std::mt19937& rng, VectorXd state) {
  clip_state(state);
...
lunar_lander_simulator::action beta_agent::update(std::mt19937& rng, VectorXd state,
