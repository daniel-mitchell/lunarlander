...
mountain_car_simulator::action multi_beta_agent::compute_action(std::mt19937& rng, const VectorXi& features) {
...
mountain_car_simulator::action multi_beta_agent::initialize(std::mt19937& rng, VectorXd state) {
  clip_state(state);
...
mountain_car_simulator::action multi_beta_agent::update(std::mt19937& rng, VectorXd state,
